...
top_nav.classList.add("bg-info")

var title = document.createElement("span")
title.classList.add("navbar-brand")
title.classList.add("mb-0")
title.classList.add("h1")
title.innerText = "Calculator Operations"
...
text_area.classList.add("text-right")
text_area.classList.add("mb-4")
text_area.setAttribute("id", "type-area")
text_area.setAttribute("readonly", "true")
text_area.setAttribute("placeholder", "0")
text_area.style.fontSize = "25px"
text_area.style.borderRadius = "10px"
text_area.style.padding = "20px 10px"
text_area.style.lineHeight = "28px"
text_area.style.border = "2px solid black"
col_1.append(text_area)
...
let n7 = numberCreate("7", "btn-outline-secondary", "seven")
let n8 = numberCreate("8", "btn-outline-secondary", "eight")
let n9 = numberCreate("9", "btn-outline-secondary", "nine")
let n_mod = numberCreate(" % ", "btn-outline-success", "n_mod")
...
let n4 = numberCreate("4", "btn-outline-secondary", "four")
let n5 = numberCreate("5", "btn-outline-secondary", "five")
let n6 = numberCreate("6", "btn-outline-secondary", "six")
let n_div = numberCreate(" / ", "btn-outline-success", "n_div")
...
let n1 = numberCreate("1", "btn-outline-secondary", "one")
let n2 = numberCreate("2", "btn-outline-secondary", "two")
let n3 = numberCreate("3", "btn-outline-secondary", "three")
let n_mul = numberCreate(" * ", "btn-outline-success", "n_mul")
...
let n_dot = numberCreate(".", "btn-outline-secondary", "n_dot")
let n0 = numberCreate("0", "btn-outline-secondary", "zero")
let n_add = numberCreate(" + ", "btn-outline-success", "n_add")
let n_sub = numberCreate(" - ", "btn-outline-success", "n_sub")
...
let n_ce = numberCreate("CE", "btn-outline-danger", "n_ce")
let n_back = numberCreate("\u232b", "btn-outline-warning", "n_back")
let n_eval = numberCreate("=", "btn-outline-info", "n_eval")
